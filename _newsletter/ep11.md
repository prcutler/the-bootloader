...
Scott Shawcroft, CircuitPython's lead developer also working on CircuitMatter, was kind enough to update me that he hopes CircuitMatter will work any microcontroller with Wi-Fi that supports IPv6. BLE is only needed if the device isn't on WiFI already.  Thanks Scott!

...
clone of the reverb module called Clouds called Supercell that adds extra
knobs and inputs to control even more of the reverb sound. I also have a clone
of Braids, one of Mutable's most popular modules, that's in a much smaller size.
...
the clone modules, repos, and inspiration her circuits and algorithms have created.
...
Fortunately, Mark Washeim, aka @poetaster on github, has ported many of the Mutable
module's code to Arduino on the Pico.  This is great! I know that well. It's one
less barrier for me and I've started poking around and trying stuff out.
...
for his Mutable porting experiments.  I was pleased and surprised to see my name
called out as he based some of the design of scarp on the various synth boards I've made
over the years.  Thanks Mark!  I can't wait to get deeper into the Mutable synth code.
...
Unfortuantely, you'll need a subscription to read the article either on Apple News or at the New Scientist website.

* https://apple.news/AXF6Y3ewsSJyk5f_e2bZUSw
* https://www.newscientist.com/article/2493756-3d-printed-electronics-can-dissolve-in-water-for-quick-recycling/ (Subscription required)

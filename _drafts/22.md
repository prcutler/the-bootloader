...
### Paul's Pick #1: Supercollider Synth Engine and Supriya Python API
[Supercollider synth engine](https://supercollider.github.io/) and [Supriya Python API](https://github.com/dayunbao/supriya_demos)
...
### Why I love building things with microcontrollers; A love letter to embedded systems

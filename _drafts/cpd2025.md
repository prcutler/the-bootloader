...
My next pick might suffer from some recency bias, but it’s just so cool I have to talk about it.  It’s so new it hasn’t even been in the Python on Hardware newsletter yet, though it was demoed on Show and Tell this week.  And that is Fruitris, a Tetris clone for the Fruit Jam.  The Fruit Jam has only been out for 2 weeks and already a community member, Cooper Dalrymple, has created a Tetris clone.

I got to know Cooper earlier this year when he was a guest twice on The CircuitPython Show and you might know of him from his work with `synthio`.  Fruitris has already had 4 releases this week and is still considered alpha, but I haven’t run into any bugs and no, I’m not going to admit to how much I’ve played when I probably should have been prepping for this show.

There’s a few different things that are really neat about Fruitris.  First, Cooper did some work to detect the display and it now supports widescreen displays and resolutions and the game play region adjusts depending on your resolution.

Second, the music is fantastic.  It’s perfect and retro in an 8 bit way.  Cooper even submitted a pull request to CircuitPython last week to update synthio and add a tempo variable - which he puts to good use in Fruitris as the music speeds up as the levels get harder and faster.

Lastly, Cooper makes excellent use of `asyncio`. One of the questions I was asked when I told someone I was playing, was if the game was laggy?  And it’s not, at all.  From the graphics to the sounds to the gameplay, it’s really well done. If and when you get a Fruit Jam, make this one of the first things you install.

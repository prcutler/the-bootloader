...
- I've been every year except for the very first one up in San Francisco and the offshoot ones they have in Europe.  My wife Carlyn and I co-founded CrashSpace, a Los Angeles hackerspace that's going on its 15th year! And when Supplyframe bought Hackaday, they had us come by a few times to talk about making a "Hackaday Hackerspace" and that turned into the DesignLab, a much nicer and cleaner space than most hackerspaces and much more usable for conferences.
